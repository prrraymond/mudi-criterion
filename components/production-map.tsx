...
import { Film, ThumbsUp, Plus, TrendingUp, Clock, CheckCircle } from 'lucide-react'
    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-400 font-light tracking-wide">
          Behind the scenes of emotional cinema discovery
        </p>
      </div>

      {/* Tabs for different production views */}
